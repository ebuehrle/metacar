...
class DDPGAgent {
    ...
    async restore(folder, name){
        ...
        */
        const critic = await tf.loadModel('https://raw.githubusercontent.com/thibo73800/metacar/master/demo/webapp/public/models/'+folder+'/critic-'+name+'.json');
        const actor = await tf.loadModel("https://raw.githubusercontent.com/thibo73800/metacar/master/demo/webapp/public/models/"+folder+"/actor-"+name+".json");
