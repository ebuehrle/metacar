...
class PolicyAgent {
    ...
    */
    ...
    async restore(){
        ...
        */
       this.valueModel = await tf.loadModel('https://raw.githubusercontent.com/thibo73800/metacar/master/demo/webapp/public/models/policy/value-model-policy-agent.json');
       this.policyModel = await tf.loadModel("https://raw.githubusercontent.com/thibo73800/metacar/master/demo/webapp/public/models/policy/policy-model-policy-agent.json");
    }
